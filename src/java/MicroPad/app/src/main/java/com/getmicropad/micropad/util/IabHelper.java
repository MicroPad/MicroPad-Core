...
package com.getmicropad.micropad.util;
    ...
    void consume(Purchase itemInfo) throws IabException {
        ...
        try {
            ...
            if (response == BILLING_RESPONSE_RESULT_OK) {
                ...
                logDebug("Error consuming consuming sku " + sku + "build/intermediates/exploded-aar/com.amitshekhar.android/android-networking/0.4.0/res " + getResponseDesc(response));
